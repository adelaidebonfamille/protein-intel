                ...
                <div>
                    ...
                    <form onSubmit={addProblemHandler}>
                        ...
                        <div className={ styles[ "text-inputs" ] }>
                            A <textarea name="key1" id="" cols="60" rows="2" required></textarea>
                            B <textarea name="key2" id="" cols="60" rows="2" required></textarea>
                            C <textarea name="key3" id="" cols="60" rows="2" required></textarea>
                            D <textarea name="key4" id="" cols="60" rows="2" required></textarea>
                            E <textarea name="key5" id="" cols="60" rows="2" required></textarea>
                        </div>
                        <p>Right Answer</p>
                        ...
                        <p>
                            <input type="radio" id="problem-type1" name="type" value="reading" required/>
                            <label htmlFor="problem-type1">Reading</label>
                        </p>
                        <p>
                            <input type="radio" id="problem-type2" name="type" value="structure" required/>
