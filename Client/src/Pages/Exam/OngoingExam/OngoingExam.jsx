        ...
        <div className={ styles.container }>
            <div className= { styles[ "small-container" ] } >
                ...
                <div className={ styles.button }>
                    <button className={ styles.button1 }>Start</button><br />
                    <button className={ styles.button2 }>Continue</button><br />
                    <button className={ styles.button3 }>Finished</button><br />
                </div>
                </div>
                <div className={ styles.end }>
                <div className= { styles[ "small-end" ] } >
                    <button>End Test</button><br />
